...
[Maya](https://www.autodesk.in/products/maya/overview) by AutoDesk is a 3D animation, modeling, simulation and rendering software. Though it is not free, it is really powerful and is an industry standard. For example, look at this video portraying features of blender:
...
Similar to visual editor in game engines, threejs also has an [online editor](https://threejs.org/editor/).
